            ...
            <div class="form-group">
                <div class="agree">
                    <p>
                        ...
                        1) “몰”이 회원 자격을 제한․정지 시킨 후, 동일한 행위가 2회 이상 반복되거나 30일 이내에 그 사유가 시정되지 아니하는 경우 “몰”은 회원자격을 상실시킬 수 있습니다.
                        2) “몰”이 회원자격을 상실시키는 경우에는 회원등록을 말소합니다. 이 경우 회원에게 이를 통지하고, 회원등록 말소 전에 최소한 30일 이상의 기간을 정하여 소명할 기회를 부여합니다.
                        3) "몰"의 제 10조제1항에 위반되는 계약을 지속하는 경우
                        4) 타인의 명예를 손상시키거나 불이익을 주는 행위를 진행한 경우
                        5) 회원이 홈페이지와 게시판에 타인에게 불편함을 줄 수 있는 게시물 또는 음란물을 게재하거나 음란사이트를 게시하는 경우

                        6) 만 14세 이하가 법정대리인 동의없이 가입을 진행한 경우                    
                        </p>
                </div>
            </div>
