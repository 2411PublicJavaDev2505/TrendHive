...
public class CompanyBoardModifyRequest {
	...
	public CompanyBoardModifyRequest() {}
	
	public CompanyBoardModifyRequest(int	companyPRNo, String productName, String productPrice, String brandName, String companyUrl,
	...
	public void setCompanyPRNo(int companyPRNo) {
		this.companyPRNo = companyPRNo;
	}
	...
	public String toString() {
		return "CompanyBoardModifyRequest [companyPRNo=" + companyPRNo + ", productName=" + productName
				+ ", productPrice=" + productPrice + ", brandName=" + brandName + ", companyUrl=" + companyUrl
				+ ", companyIntro=" + companyIntro + ", companyPosting=" + companyPosting + ", productInfo="
				+ productInfo + ", forCreator=" + forCreator + ", companyEmail=" + companyEmail + ", companyPhone="
				+ companyPhone + ", fileName=" + fileName + ", fileRename=" + fileRename + ", filePath=" + filePath
				+ ", companyId=" + companyId + "]";
	}
